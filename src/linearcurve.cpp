...
public:
    ...
    SurfaceInteraction3f compute_surface_interaction(const Ray3f &ray,
        ...
        // For consistent curve shading frames
        // Mitsuba uses these values to initialise a shading fram in
        // interaction.h -> finalize_surface_interaction() -> initialize_sh_frame()
        si.sh_frame.n = si.n;					// Surface normal
        si.dp_du = dr::normalize(p1 - p0);			// Yarn tangent
        si.dp_dv = dr::normalize(dr::cross(si.n, si.dp_du));	// Bitangent
